...
import martin.pelcatm.channelmessaging.Message;
import martin.pelcatm.channelmessaging.MessageResponse;
...
/**
 * Created by pelcatm on 06/03/2018.
 */
public class ChannelFragment extends AppCompatActivity implements View.OnClickListener,OnDownloadListener{
        ...
        listeVue = (ListView) findViewById(R.id.listViewFragment);
        editText = (EditText) findViewById(R.id.editTextFragment);
        ...
        btnValider = (Button) findViewById(R.id.buttonMsgFragment);
